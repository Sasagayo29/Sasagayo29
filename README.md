...
Atualmente, curso Análise e Desenvolvimento de Sistemas pelo IFTM-Paracatu e atuo como Insdustrial Data Analyst na Radix Engenharia e Desenvolvimento de Software, onde desenvolvo soluções de automação de processos com RPA, macros, VBA e scripts personalizados. Tenho experiência consolidada no desenvolvimento de sistemas internos, dashboards interativos e automações que otimizam fluxos de trabalho, reduzem tarefas manuais e apoiam a tomada de decisão com foco em eficiência operacional e escalabilidade.

Minhas principais competências incluem:

📌 Desenvolvimento backend e frontend com foco em performance, escalabilidade e boas práticas de código.

📊 Construção de dashboards e relatórios integrados a bases de dados com foco em indicadores de performance e inteligência operacional.

🤖 Automação de tarefas rotineiras com RPA e integração entre ferramentas corporativas.

🔁 Uso de controle de versão (Git), metodologias ágeis, CI/CD e ferramentas modernas de desenvolvimento.

🏭 Atuação técnica em ambientes industriais, incluindo suporte técnico, gestão de indicadores e projetos de inovação digital.

Tenho facilidade de aprendizado, alta adaptabilidade e perfil proativo para resolução de problemas complexos. Busco constantemente evolução técnica e estou sempre alinhado às melhores práticas do mercado para entregar soluções robustas, seguras e eficientes.
...
<div align="left">
  ...
  <img src="https://img.shields.io/badge/ETL-9370DB?logo=airbyte&logoColor=fff"/>
</div>
...
<div align="left">
  ...
  <img src="https://custom-icon-badges.demolab.com/badge/Visual%20Studio-5C2D91?logo=visualstudio&logoColor=white"/>
  <img src="https://img.shields.io/badge/IntelliJ%20IDEA-000000?logo=intellij-idea&logoColor=white"/>
  <img src="https://img.shields.io/badge/NetBeans%20IDE-1B6AC6?logo=apache-netbeans-ide&logoColor=white"/>
</div>
...
> Projetos acadêmicos e pessoais que demonstram minhas habilidades técnicas e capacidade de entrega:
...
| ⛏️ [MineFlow](https://github.com/Sasagayo29/MineFlowUpgrade) | Ferramenta de criação de fluxos de trabalho através de uma planilha Excel. | Electron, JavaScript, HTML, CSS, Mermaid.js, SheetJS |
...
<picture align="center">
  ...
  <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/Sasagayo29/Sasagayo29/output/github-contribution-grid-snake.svg">
  <img alt="Snake animation" src="https://raw.githubusercontent.com/Sasagayo29/Sasagayo29/output/github-contribution-grid-snake.svg">
</picture>
